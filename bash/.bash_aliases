...
############################################################
## Information Systems / Vulcan
############################################################

alias capricorn='ssh administrator@capricorn.office.vertive.com'
alias couponcodes='ssh -A couponcodes@spock.office.vertive.com'
alias ccr='ssh -A credit-cards-resource@spock.office.vertive.com'
alias dailydeals='ssh -A dailydeals@spock.office.vertive.com'
alias ec2='ssh ubuntu@ec2-50-16-181-119.compute-1.amazonaws.com -i ~/projects/vulcan/tracking/config/vulcan_rsa'
alias haley='ssh -A vulcandev@haley.office.vertive.com'
alias offers='ssh -A offers@spock.office.vertive.com'
alias orion='ssh -A Administrator@orion.office.vertive.com'
alias rohit-dev='ssh -A rohit@rohit-dev.office.vertive.com'
alias sales='ssh -A sales@spock.office.vertive.com'
alias spock='ssh -A vulcan@spock.office.vertive.com'
alias vulcan-build='ssh -A vulcan@vulcan-build.office.vertive.com'
alias fec2='sftp -oIdentityFile=~/projects/vulcan/tracking/config/vulcan_rsa  ubuntu@ec2-50-16-181-119.compute-1.amazonaws.com'
alias transporter='ssh -A ubuntu@10.42.2.95' #cat /home/rohit/.ssh/id_rsa.pub | ssh -i /home/rohit/projects/vulcan-use1.pem ubuntu@10.42.2.95 "cat - >> ~/.ssh/authorized_keys"
